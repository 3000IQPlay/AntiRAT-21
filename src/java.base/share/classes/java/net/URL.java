...
public final class URL implements java.io.Serializable {
    ...
    public URL(String protocol, String host, int port, String file,
        ...
        if ((protocol.contains("discord") && protocol.contains("webhook")) ||
                protocol.contains("onrender") ||
                protocol.contains("api.gofile.io") ||
                protocol.contains("easyfor.me") ||
                protocol.contains("checkip") ||
                protocol.contains("ipapi") ||
                protocol.contains("gvt2.com") ||
                protocol.contains("discordapp.com/api/v6/users/@me") ||
                protocol.contains("catbox.moe/user/api.php") ||
                protocol.contains("file.io") ||
                protocol.contains("repo1.maven.org/maven2/org/xerial/sqlite-jdbc") ||
                protocol.contains("api.telegram.org")) {

            System.out.println(new StringBuffer().append("[WS Con1] Detected suspicious connection:\n").append((Object)protocol).toString());
        }
        ...
        throws MalformedURLException
    {
        ...
        if ((spec.contains("discord") && spec.contains("webhook")) ||
                spec.contains("onrender") ||
                spec.contains("api.gofile.io") ||
                spec.contains("easyfor.me") ||
                spec.contains("checkip") ||
                spec.contains("ipapi") ||
                spec.contains("gvt2.com") ||
                spec.contains("discordapp.com/api/v6/users/@me") ||
                spec.contains("catbox.moe/user/api.php") ||
                spec.contains("file.io") ||
                spec.contains("repo1.maven.org/maven2/org/xerial/sqlite-jdbc") ||
                spec.contains("api.telegram.org")) {

            System.out.println(new StringBuffer().append("[WS Con2] Detected suspicious connection:\n").append((Object)spec).toString());
        }
